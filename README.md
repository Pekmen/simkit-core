...
Latest benchmark results for version 0.7.3 (10/9/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 8,968 |
| Simple Iteration | 3,156 |
| Fragmented Iteration | 13,648 |
| Entity Cycle | 3,037 |
| Add/Remove Component | 5,453 |
