...
Latest benchmark results for version 0.4.0 (9/28/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 917 |
| Simple Iteration | 298 |
| Fragmented Iteration | 1,284 |
| Entity Cycle | 102 |
| Add/Remove Component | 3,302 |
