...
Latest benchmark results for version 0.10.0 (9/12/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 1,637 |
| Simple Iteration | 494 |
| Fragmented Iteration | 2,765 |
| Entity Cycle | 133 |
| Add/Remove Component | 6,545 |
