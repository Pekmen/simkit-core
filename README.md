...
Latest benchmark results for version v0.3.4 (9/22/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 1,100 |
| Simple Iteration | 387 |
| Fragmented Iteration | 1,702 |
| Entity Cycle | 126 |
| Add/Remove Component | 3,968 |
