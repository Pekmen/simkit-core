...
Latest benchmark results for version 0.8.5 (10/20/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 5,336 |
| Simple Iteration | 2,122 |
| Fragmented Iteration | 8,599 |
| Entity Cycle | 1,559 |
| Add/Remove Component | 2,891 |
