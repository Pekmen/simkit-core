...
Latest benchmark results for version 0.11.0 (9/12/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 1,600 |
| Simple Iteration | 476 |
| Fragmented Iteration | 2,677 |
| Entity Cycle | 117 |
| Add/Remove Component | 6,480 |
