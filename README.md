...
Latest benchmark results for version 0.7.6 (10/19/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 11,351 |
| Simple Iteration | 5,051 |
| Fragmented Iteration | 21,263 |
| Entity Cycle | 3,616 |
| Add/Remove Component | 5,912 |
