...
Latest benchmark results for version 0.5.2 (10/4/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 3,019 |
| Simple Iteration | 767 |
| Fragmented Iteration | 3,164 |
| Entity Cycle | 2,327 |
| Add/Remove Component | 3,920 |
