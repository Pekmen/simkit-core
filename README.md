...
Latest benchmark results for version 0.9.0 (9/12/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 1,556 |
| Simple Iteration | 519 |
| Fragmented Iteration | 2,586 |
| Entity Cycle | 129 |
| Add/Remove Component | 6,552 |
