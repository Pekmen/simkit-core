...
Latest benchmark results for version 0.5.0 (10/2/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 943 |
| Simple Iteration | 322 |
| Fragmented Iteration | 1,409 |
| Entity Cycle | 2,057 |
| Add/Remove Component | 3,521 |
