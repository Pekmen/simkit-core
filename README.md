...
Latest benchmark results for version 0.26.0 (9/12/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 1,635 |
| Simple Iteration | 487 |
| Fragmented Iteration | 2,564 |
| Entity Cycle | 114 |
| Add/Remove Component | 6,311 |
