...
Latest benchmark results for version 0.7.4 (10/18/2025):

| Benchmark | Operations/sec |
|-----------|---------------:|
| Packed Iteration (5 queries) | 9,357 |
| Simple Iteration | 3,221 |
| Fragmented Iteration | 12,368 |
| Entity Cycle | 2,544 |
| Add/Remove Component | 3,731 |
